...
class DecisionNode(Node):
    def __init__(self):
        ...
        # --- Configuration ---
        self.bins_data = {
            0: {'name': 'bin_0', 'location': (2.57, -0.07, 0.002),  'fill': 0.0},
            1: {'name': 'bin_1', 'location': (2.55,  2.27, -0.001), 'fill': 0.0},
            2: {'name': 'bin_2', 'location': (0.27128, 1.0783, -0.001), 'fill': 0.0},
        }
        self.fill_threshold = 75.0 
        self.required_stop_duration_sec = 3.0 # The wait time at the bin
